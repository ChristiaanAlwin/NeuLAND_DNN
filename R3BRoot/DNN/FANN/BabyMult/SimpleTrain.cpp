...
void SimpleTrain()
{
    ...
    Int_t nInputs = 2;
    Int_t nOutputs = 6;
    Double_t Activation_Steepness = 1.0;
    Double_t LearningRate = 0.3;
    ...
    fann_train_on_file(ann,TrainingFile.Data(),nEpochs,1,DesiredError);
...
{
  TApplication* TheApp = new TApplication("SimpleTrain",&argc,argv);
  SimpleTrain();
