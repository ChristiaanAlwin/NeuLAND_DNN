...
int main()
{
    ...
    fann_train_on_file(ann,"./DataSets/DNN_TrainingFile2.txt",200,10,1e-6);
    // 1) the network.
	...
	struct fann_train_data* data = fann_read_train_from_file("./DataSets/DNN_VerificationFile2.txt");
