...
void unpack_pspx2_online(Int_t run_nr = 1, Int_t date = 180821, Int_t detector = 2, Int_t runid = 21)
{
    //    Int_t RunId=100;
    ...
    /* Create source using ucesb for input ------------------ */
     ...
     TString filename2 = "stream://x86l-30";
...
//    TString filename = Form("/home/land/PSPX/lmd_tests/mounted/beam_181128/pspx1_pspx2_run19_000[1-9].lmd", run_nr);
    TString outputFileName = Form("/home/land/PSPX/rootfiles_tests/beam_181205_online/pspx1_pspx2_online%i.root",run_nr);
...
//    TString ucesb_path = "/lynx/Lynx/land/usr/land/landexp/kvi2018/upexps/kvi2018/kvi2018_001_060"; //--allow-errors
   ...
   // TString parPspxHitFileName = "alpha18_pspx_hit_default.par";
    ...
    /*Test*/ 
    R3BUcesbSource* source2 =
        new R3BUcesbSource2(filename2, ntuple_options, ucesb_path, &ucesb_struct, sizeof(ucesb_struct));
    source2->SetMaxEvents(nev);
    ...
    /*Test*/
   /* source2->AddReader(new R3BUnpackReader((EXT_STR_h101_unpack*)&ucesb_struct.unpack, offsetof(EXT_STR_h101, unpack)));
    source2->AddReader(new R3BPspxReader((EXT_STR_h101_PSP*)&ucesb_struct.psp, offsetof(EXT_STR_h101, psp)));*/
    ...
    run->SetRunId(runid);
    run->ActivateHttpServer(refresh,1200);
    
    /*Test*/
    /*FairRunOnline* run2 = new FairRunOnline(source2);
    run2->SetRunId(runid);
    run2->ActivateHttpServer(refresh,1200);*/
